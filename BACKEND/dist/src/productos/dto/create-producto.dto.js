...
class CreateProductoDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: true, type: () => String }, descripcion: { required: true, type: () => String }, imagen: { required: true, type: () => String }, precio: { required: true, type: () => Number }, stock: { required: true, type: () => Number }, fechaCreacion: { required: true, type: () => Date }, marca: { required: true, type: () => String }, categoriaId: { required: true, type: () => Number } };
    }
}
